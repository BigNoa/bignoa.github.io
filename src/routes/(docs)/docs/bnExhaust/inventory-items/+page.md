---
title: bnExhaust - Inventory Items
---
...
<Alert type="info">
Don't forget to add the corresponding <code>.png</code> images to your inventory's images folder.
</Alert>
{:else}
Insert the items into your database's `items` table:
